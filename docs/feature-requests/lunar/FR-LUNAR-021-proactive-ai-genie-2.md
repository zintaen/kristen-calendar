...
related_frs: []
depends_on: [FR-LUNAR-015, FR-LUNAR-017]
blocks: []
source_pages:
  - BACKLOG.md
source_decisions:
...
4. **MUST** call the Claude proxy (`FR-LUNAR-015`) to generate a personalised message for each user, providing user metadata (name, age, past interactions) without including PII like phone numbers.
