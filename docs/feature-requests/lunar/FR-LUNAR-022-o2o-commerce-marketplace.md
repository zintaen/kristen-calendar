...
sub_tasks:
  ...
  - "2h: Integrate the logic to inject affiliate links into Proactive ZNS (FR-021)"
...
Reminding users of lunar occasions only solves 50% of their needs. The other 50% is "what do I prepare for this occasion and where do I buy it?". The app currently has no clear monetization flow beyond freemium (FR-LUNAR-020). Providing affiliate links solves both the user's pain and the revenue problem.
