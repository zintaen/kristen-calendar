...
Rules, matching the repo's existing task discipline:
...
- Follow `docs/AGENT-GUIDE.md` and the golden rules in the root `README.md`; `docs/tasks/lunar/CONTRACT.md` remains the API authority for amlich-core imports.
