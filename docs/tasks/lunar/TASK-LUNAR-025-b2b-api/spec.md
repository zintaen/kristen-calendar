...
related_frs: []
depends_on: [TASK-LUNAR-001, TASK-LUNAR-011]
blocks: []
source_pages:
  - BACKLOG.md
source_decisions:
...
- **Upstream:** TASK-LUNAR-001 (Core Lunar Engine - `amlich-core`).
- **Upstream:** TASK-LUNAR-011 (API Backend initialization).
