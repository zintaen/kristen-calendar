...
npx supabase start   # Khởi động local Supabase (DB, Auth, Storage, Edge Functions)
npx supabase status  # Xem URL và Key cục bộ
npx supabase stop    # Dừng local Supabase
```
